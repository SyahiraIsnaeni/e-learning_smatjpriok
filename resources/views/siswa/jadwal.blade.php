...
<div class="mx-5 sm:mx-8 lg:mx-10 xl:mx-20 flex">
    <div>
        <h1 class="font-bold text-lg lg:text-xl xl:text-2xl">
            Penjadwalan {{$siswa->kelas->nama_kelas}}
        </h1>
        <p
            class="font-medium text-[14px] md:text-[15px] lg:text-base xl:text-lg mt-2 xl:mt-3"
        >
            Mari telusuri jadwalmu untuk meningkatkan kegiatan belajarmu!
        </p>
    </div>
    <div class="w-fit ml-auto">
        <a href="{{route("dashboard-siswa", ["id" => $siswa->id])}}">
            <div
...
<section class="mt-5 md:mt-10 lg:mt-12 mx-5 sm:mx-8 xl:mx-20 lg:mx-10 xl:mt-10 mb-10 ">
    <table class="justify-evenly w-full text-center">
        ...
        <tr>
            ...
            <th class="border px-1 py-1 md:py-2 border-black bg-[#99AEBB] bg-opacity-55 text-[13.5px] font-semibold sm:text-sm md:text-[15px] lg:text-base xl:text-[17px]">Guru</th>
