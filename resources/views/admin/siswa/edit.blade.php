...
<div class="mx-5 sm:mx-8 lg:mx-10 xl:mx-20">
    <h1 class="font-bold text-lg lg:text-xl xl:text-2xl">Edit Data Siswa</h1>
</div>

<section class="mt-5 mb-10 xl:mt-8">
    <div class="mx-5 sm:mx-8 lg:mx-10 xl:mx-20">
        <form method="post" enctype="multipart/form-data" action="{{route("edit-detail-data-siswa", ["id" => $siswa->id])}}">
            @csrf
            <div class="block w-full lg:flex lg:gap-10 xl:gap-20">
                <div class="lg:w-1/2">
                    <div class="mt-5 md:mt-8 lg:mt-5 rounded-md">
                        ...
                        <input value="{{$siswa->nama}}" disabled class="mt-1.5 py-1 px-2 lg:py-1.5 w-full rounded-md text-[13px] sm:text-sm lg:text-[14px] xl:text-[15px] border border-black border-opacity-25">
                    </div>
                    <div class="mt-2 md:mt-3 lg:mt-5 rounded-md">
                        ...
                        <input value="{{$siswa->nis}}" disabled class="mt-1.5 py-1 px-2 lg:py-1.5 w-full rounded-md text-[13px] sm:text-sm lg:text-[14px] xl:text-[15px] border border-black border-opacity-25">
                    </div>
                    <div class="mt-2 md:mt-3 lg:mt-5 rounded-md">
                        <p class="text-[13.5px] sm:text-sm lg:text-[14.5px] xl:text-base font-medium bg-white">Kelas</p>
                        <input value="{{$siswa->kelas->nama_kelas}}" disabled class="mt-1.5 py-1 px-2 lg:py-1.5 w-full rounded-md text-[13px] sm:text-sm lg:text-[14px] xl:text-[15px] border border-black border-opacity-25">
                    </div>
                    <div class="mt-2 md:mt-3 lg:mt-5 rounded-md">
                        <p class="text-[13.5px] sm:text-sm lg:text-[14.5px] xl:text-base font-medium">Email (opsional)</p>
                        <input value="{{$siswa->email}}" name="email" class="mt-1.5 lg:py-1.5 py-1 px-2 text-[13px] sm:text-sm lg:text-[14px] xl:text-[15px] w-full rounded-md border border-black border-opacity-25">
                    </div>
                </div>
                <div class="lg:w-1/2">
                    <div class="mt-2 md:mt-3 lg:mt-5 rounded-md">
            ...
            <div class="mt-8 xl:mt-10 flex">
                <div class="w-fit">
                    <a href="{{route("data-siswa", ["kelasId" => $siswa->kelas->id])}}">
                        <div
