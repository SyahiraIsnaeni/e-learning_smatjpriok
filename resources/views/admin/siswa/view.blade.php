    ...
    <div class="hidden mx-5 sm:mx-8 lg:mx-10 xl:mx-20 md:grid grid-cols-2">
        ...
        >
            <a href="{{route("dashboard-admin")}}">
                <p
                    class="hover:text-oren font-bold"
                >
                    Dashboard
                </p>
            </a>
...
<div class="mx-5 sm:mx-8 lg:mx-10 xl:mx-20 flex">
    <h1 class="font-bold text-lg lg:text-xl xl:text-2xl">Data Kelas</h1>
                    ...
                    @foreach($kelas as $row)
                        <tr class="text-[13px] sm:text-sm md:text-[15px] lg:text-base xl:text-[17px]">
                            ...
                            <td class="border-r border-b border-black px-1 py-1 md:py-2 sm:flex justify-center items-center">
                                <a href="{{route("data-siswa", ["kelasId" => $row->id])}}" class="flex justify-center items-center">
                                    <div class="bg-[#02455C] rounded-md px-1.5 py-1.5 w-fit hover:scale-105 duration-300 ease-in-out">
                                        <p class="text-[13px] md:text-sm lg:text-[15px] xl:text-base text-white">Pilih Kelas</p>
                                    </div>
                                </a>
                            </td>
                        </tr>
