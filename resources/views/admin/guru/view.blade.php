...
<div class="mx-5 sm:mx-8 lg:mx-10 xl:mx-20 flex">
    <h1 class="font-bold text-lg lg:text-xl xl:text-2xl">Data Guru</h1>
...
<section class="mt-5 mb-10 xl:mt-8">
    <div class="mx-5 sm:mx-8 lg:mx-10 xl:mx-20">
        ...
        <div class="md:flex">
            <div
                class="border mt-3 md:w-1/3 md:mt-0 rounded-md border-black border-opacity-30 bg-white pl-3 flex"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    class="w-[18px] h-[18px] mt-2 opacity-50 mr-2"
                >
                    <path
                ...
                <input
                    class="py-2 placeholder:text-[13.5px] placeholder:lg:text-sm text-sm w-full rounded-md"
            ...
            <form>
                <table class="justify-evenly w-full text-center">
                    ...
                    <tr>
                        ...
                        <th class="border px-1 py-1 md:py-2 border-black bg-[#99AEBB] bg-opacity-55 text-[13.5px] font-semibold sm:text-sm md:text-[15px] lg:text-base xl:text-[17px]">NIP</th>
                    ...
                    @foreach($guru as $row)
                        <tr class="text-[13px] sm:text-sm md:text-[15px] lg:text-base xl:text-[17px]">
                            ...
                            <td class="border-r border-b border-black px-1 py-1 md:py-2 sm:flex justify-center items-center">
                                <a href="{{route("edit-data-guru", ["id" => $row->id])}}" class="flex justify-center items-center">
