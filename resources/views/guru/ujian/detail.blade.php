...
<section class="text-black mt-8 xl:mt-10">
    <div class="mx-5 sm:mx-8 lg:mx-10 xl:mx-20">
        ...
        >
            ...
            >
                Waktu: {{ abs(\Carbon\Carbon::createFromFormat('H:i:s', $ujian->durasi)->diffInMinutes(\Carbon\Carbon::createFromFormat('H:i:s', '00:00:00'))) }} menit
            </p>
            <p
        ...
        >
            <div class="sm:flex">
                ...
                <div class="sm:ml-auto flex">
                    <a class="w-fit" href="{{route("detail-nilai-guru-examination", ["mapelId" => $mapel["mapel_id"], "ujianId" => $ujian->id, "guruId" => $guru->id])}}">
                    ...
                    >
                        Total Pengumpulan: {{count($ujian->pengerjaanSiswa)}} Siswa
                    </p>
                </div>
            </div>
            <!-- TAMPILAN HP -->
