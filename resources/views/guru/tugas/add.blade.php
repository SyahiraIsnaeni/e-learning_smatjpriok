...
<section class="text-black mt-8 xl:mt-12 mb-10">
    <div class="mx-5 sm:mx-8 lg:mx-10 xl:mx-20">
        <form action="{{ route('add-guru-data-assignment', ['mapelId' => $mapel['mapel_id'], 'guruId' => $guru->id])}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <label for="deadline" class="lg:flex mt-5">
                <div class="lg:w-1/4">
                    <p class="text-[13.5px] lg:text-[15px] xl:text-base font-medium mt-3 xl:mt-4">
                        Tenggat/Deadline
                    </p>
                </div>
            ...
            <div class="lg:flex mt-3 lg:mt-7">
                ...
                <div class="lg:w-3/4 mt-2.5 lg:mt-0">
                    ...
                    <div id="selected-files" class="text-sm text-gray-700 mt-2.5"></div>
