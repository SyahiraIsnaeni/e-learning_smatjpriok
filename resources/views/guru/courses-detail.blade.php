...
<section class="text-black mt-8  xl:mt-12">
    <div class="mx-5 sm:mx-8 lg:mx-10 xl:mx-20">
        ...
        <h1 class="font-medium text-sm lg:text-base xl:text-lg mt-1.5 lg:mt-2.5 xl:mt-3">{{$mapel["nama_kelas"]}}</h1>
    </div>
</section>
...
<section class="text-black mt-8 md:mt-10 mb-10 xl:mt-12">
    ...
    >
        ...
        <div class="transition ease-in-out hover:-translate-y-1 duration-300 hover:scale-105">
            <a href="../materi/list-materi/guru.html">
